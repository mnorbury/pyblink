...
class TestOutputSource(object):
    ...
    def __init__(self):
        ...
        self.output_source = Blink1Indicator(0.1,
                                             self.mock_pattern,
                                             self.mock_client)
    ...
    def test_creating_new_pattern(self):
        ...
        self.mock_pattern.assert_called_with((255, 0, 0), 0.1, 1, 60)

    def test_only_create_pattern_first_time(self):
        self.output_source.update(dict(color='red', activity=1))
        self.output_source.update(dict(color='red', activity=1))

        self.mock_pattern.assert_called_once_with((255, 0, 0), 0.1, 1, 60)
    ...
    def test_create_pattern_if_color_changes(self):
        ...
        self.mock_pattern.assert_called_with((255, 255, 0), 0.1, 1, 60)
